...
int main(int, char**) {
	...
	Door door = Door(1112, 20, renderer);
	...
	while (!quit) {
		...
		if (menu->playBool == true)
		{
			...
			if (fireball1->CheckLife())
			{
				if (dir == 2)
				{
					fireball1 = new Fireball(825, 379, World, renderer);
				}
				if (dir == 1)
				{
					fireball1 = new Fireball(-275, 379, World, renderer);
				}
			}
			if (fireball2->CheckLife())
			{
				if (dir == 2)
				{
					fireball2 = new Fireball(825, 379, World, renderer);
				}
				if (dir == 1)
				{
					fireball2 = new Fireball(-275, 379, World, renderer);
				}
			}
			if (fireball3->CheckLife())
			{
				if (dir == 2)
				{
					fireball3 = new Fireball(825, 379, World, renderer);
				}
				if (dir == 1)
				{
					fireball3 = new Fireball(-275, 379, World, renderer);
				}
			}
			if (fireball4->CheckLife())
			{
				if (dir == 2)
				{
					fireball4 = new Fireball(825, 379, World, renderer);
				}
				if (dir == 1)
				{
					fireball4 = new Fireball(-275, 379, World, renderer);
				}
			}
			button.Update();
